...
function App() {
  return (
    <div className="App">
      <header>
        ...
        <ul className="barra-nav">
            ...
            <li><a href="./pca.html">Diseño PCA</a></li>
            <li><a href="./flujo-libre.html">Diseño Flujo Libre</a></li>
            <li><a href="./suelos-sucs.html">Clasificación de suelos SUCS</a></li>
            <li><a href="./porticos-conc.html">Diseño de pórticos de concreto</a></li>
        </ul>
    </header>
    ...
    <main>
        ...
        <div className="datos-entrada">
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input required className="input-numero" type="number" name="mod-reaccion" id="mod-reaccion" min="0"/>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input required className="input-numero" type="number" name="mod-rotura" id="mod-rotura" min="0"/>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input required className="input-numero" type="number" name="espesor" id="espesor" min="0"/>
                                </td>
                                <td>
            ...
            <div>
                ...
                <div className="titulos-ejes">
                    <span>Ejes simples</span><span>Ejes tándem</span><span>Ejes trídem</span>
                </div>
        ...
        <input className="input-numero-salida" type="number" name="dfatiga" id="dfatiga" disabled />
        <br /><br />
        <label for="derosion">Daño por erosión:</label>
        <input className="input-numero-salida" type="number" name="derosion" id="derosion" disabled />
